# 🎮 GameStoreMVC - Tienda Virtual de Videojuegos
...
* **Acceso a Datos:** ADO.NET (Nativo con `Microsoft.Data.SqlClient`)
* **Frontend:** Razor Views (.cshtml), Bootstrap 5, CSS
...
* Tener la carga de trabajo "Desarrollo de ASP.NET y web" habilitada en Visual Studio.

### 2. Clonar el Repositorio
```bash
git clone https://github.com/Antonio10er/GameStoreMVC.git 
